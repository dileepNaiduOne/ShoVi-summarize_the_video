...
aai.settings.api_key = "c323ab05a7bc4302ac1246aaec21416c"
...
The youtube video transcribe is {text}. Now give the summary of this.'''
...
summary = llm_chain.invoke({"text" : text}).content
print(summary)
